...
class __TwigTemplate_8d2e0b50d939b0a8970ba31731f44384cbcf413f78fb34cf6555a87b7ae8d603 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"col-6 p-4 m-3 mx-auto\">
    ...
    {{form_start(form)}}
    {{form_widget(form)}}
    <a href=\"{{path('account_password')}}\">Modifier le mot de passe </a>
    {{form_end(form)}}

</div>

{% endblock %}", "account/profile.html.twig", "C:\\Users\\walid\\Desktop\\symfony_airbnb\\templates\\account\\profile.html.twig");
    }
}
