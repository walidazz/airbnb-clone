...
class __TwigTemplate_e6d927fc16ca9da53ee34153314af818bf876d1483a3a4f6d32b78ad80482635 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"car bg-light\">
        <div class=\"card-header\">
            ...
            <h4 class=\"card-title\"><i class=\"fas fa-lock\"> Connexion à l'administration</i></h4>
        </div>
        ...
        if ((isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 15, $this->source); })())) {
            // line 16
            echo "        <span>Les informations sont incorrects !</span>
        ";
        }
        // line 18
        echo "
        <div class=\"card-body\">
            <form action=\"\" method=\"post\">
                ...
                <div class=\"form-group\"><label for=\"_username\"></label><input type=\"text\" class=\"form-controle\"
                        placeholder=\"Adresse email\" name=\"_username\">";
        // line 23
        ...
        echo "</div>
                <div class=\"form-group\"><label for=\"_password\"></label><input type=\"password\" class=\"form-controle\"
                        placeholder=\"Mot de passe\" name=\"_password\"></div>

                <div class=\"form-group\"><button type=\"submit\" class=\"btn btn-primary\">
                        <i class=\"fas fa-lock-open\"></i> Connexion
                    </button>
                    <a href=\"";
        // line 30
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("annonces");
        echo "\" class=\"btn btn-link\"> <i class=\"fas fa-arrow-circle-left\"></i> Retour
                        au
                        site</a>
                </div>
            </form>
...
";
    ...
    {
        return array (  121 => 30,  111 => 23,  104 => 18,  100 => 16,  98 => 15,  88 => 7,  78 => 6,  59 => 3,  36 => 1,);
    }
...
<div class=\"col-md-4 mx-auto mt-5\">
    ...
    <div class=\"car bg-light\">
        ...
        {% if error %}
        <span>Les informations sont incorrects !</span>
        {% endif %}
        ...
        <div class=\"card-body\">
            <form action=\"\" method=\"post\">
                ...
                <div class=\"form-group\"><label for=\"_username\"></label><input type=\"text\" class=\"form-controle\"
                        placeholder=\"Adresse email\" name=\"_username\">{{lastname}}</div>
                <div class=\"form-group\"><label for=\"_password\"></label><input type=\"password\" class=\"form-controle\"
                        placeholder=\"Mot de passe\" name=\"_password\"></div>
                ...
                <div class=\"form-group\"><button type=\"submit\" class=\"btn btn-primary\">
                    ...
                    <a href=\"{{path('annonces')}}\" class=\"btn btn-link\"> <i class=\"fas fa-arrow-circle-left\"></i> Retour
                        au
                        site</a>
                </div>
            </form>
...
{% endblock %}", "admin/account/login.html.twig", "C:\\Users\\walid\\Desktop\\symfony_airbnb\\templates\\admin\\account\\login.html.twig");
    }
}
