...
class Booking
{
     ...
     * @Assert\GreaterThan("today",message="date incorrect ", groups={"front"})
     */
    private $startDate;

    /**
     * @ORM\Column(type="datetime")
     * @Assert\GreaterThan(propertyPath="startDate", message="date pas bonne")
     */
    private $endDate;
    ...
    public function isBookableDate()
    {
        ...
        foreach ($days as $day) {
            if (array_search($day, $notAvaible) !== false) return false;
        }
        return true;
    }
